...
mycon = sql.connect(host="localhost", user="root", password="root", database="grocery_store")
cur1 = mycon.cursor()
cur2 = mycon.cursor()
...
def submit2():
    ...
    myconnect = sql.connect(host="localhost", user="root", password="root", database="grocery_store")
...
def admin_window():
    ...
    Button(frame3,image=about_btn,bd=0,borderwidth=0,bg="#d5eff5").place(x=965,y=300)
...
def add_products():
    ...
    def addbtn_func():
        try:
            if(addname_t1.get() == " " or len(addname_t1.get()) == 0):
                ...
                if op > 0:
                    mycon1 = sql.connect(host="localhost", user="root", password="root", database="grocery_store")
                    cur3 = mycon1.cursor()
                    cur3.execute("insert into products(category,sub_category,product_name,stock_quantity,MRP) VALUES(%s,%s,%s,%s,%s)",
                    (addcat_t1.get(),addsubcat_t1.get(),addname_t1.get(),addstock_t1.get(),addprice_t1.get())
                    )
                    mycon1.commit()
                    mycon1.close()
    ...
    Label(prod_inside_frame,text="Product Name:",font=("Verdana",15),bg="white",fg="#3d3d3d").place(x=20,y=35)
    add_entry1 = Entry(prod_inside_frame,font=("Verdana",11),width=30,bd=2,relief=GROOVE,textvariable=addname_t1)
    add_entry1.place(x=200,y=39)

    Label(prod_inside_frame,text="Category:",font=("Verdana",15),bg="white",fg="#3d3d3d").place(x=20,y=105)
    add_entry2 = Entry(prod_inside_frame,font=("Verdana",11),width=30,bd=2,relief=GROOVE,textvariable=addcat_t1)
    add_entry2.place(x=200,y=109)

    Label(prod_inside_frame,text="Sub-Category:",font=("Verdana",15),bg="white",fg="#3d3d3d").place(x=20,y=175)
    add_entry3 = Entry(prod_inside_frame,font=("Verdana",11),width=30,bd=2,relief=GROOVE,textvariable=addsubcat_t1)
    add_entry3.place(x=200,y=179)

    Label(prod_inside_frame,text="Stock(Qty):",font=("Verdana",15),bg="white",fg="#3d3d3d").place(x=20,y=245)
    add_entry4 = Entry(prod_inside_frame,font=("Verdana",11),width=30,bd=2,relief=GROOVE,textvariable=addstock_t1)
    add_entry4.place(x=200,y=249)

    Label(prod_inside_frame,text="Price(INR):",font=("Verdana",15),bg="white",fg="#3d3d3d").place(x=20,y=315)
    add_entry5 = Entry(prod_inside_frame,font=("Verdana",11),width=30,bd=2,relief=GROOVE,textvariable=addprice_t1)
    add_entry5.place(x=200,y=319)

    add_btn = PhotoImage(file="images/buttons/add_btn.png")
    Button(prod_inside_frame,image=add_btn,bg="white",bd=0,borderwidth=0,command=addbtn_func).place(x=80,y=420)

    clr_btn_1 = PhotoImage(file="images/buttons/clear_btn_1.png")
    Button(prod_inside_frame,image=clr_btn_1,bg="white",bd=0,borderwidth=0,command=clrbtn_func).place(x=285,y=420)
...
def add_employees():
        ...
        try:
            if(addname_t1.get() == " " or len(addname_t1.get()) == 0):
                ...
                if op > 0:
                    mycon1 = sql.connect(host="localhost", user="root", password="root", database="grocery_store")
                    cur3 = mycon1.cursor()
                    cur3.execute("insert into employees(employee_name,contact_num,address,aadhar_num,username,password) VALUES(%s,%s,%s,%s,%s,%s)",
                    (addname_t1.get(),addcontact_t1.get(),add_address_t1.get(),addadhar_t1.get(),addusername_t1.get(),addpassword_t1.get(),)
                    )
                    mycon1.commit()
                    mycon1.close()
    ...
    Label(emp_inside_frame,text="Employee Name:",font=("Verdana",15),bg="white",fg="#3d3d3d").place(x=20,y=35)
    add_entry1 = Entry(emp_inside_frame,font=("Verdana",11),width=30,bd=2,relief=GROOVE,textvariable=addname_t1)
    add_entry1.place(x=200,y=39)

    Label(emp_inside_frame,text="Contact Num:",font=("Verdana",15),bg="white",fg="#3d3d3d").place(x=20,y=105)
    add_entry2 = Entry(emp_inside_frame,font=("Verdana",11),width=30,bd=2,relief=GROOVE,textvariable=addcontact_t1)
    add_entry2.place(x=200,y=109)

    Label(emp_inside_frame,text="Address:",font=("Verdana",15),bg="white",fg="#3d3d3d").place(x=20,y=175)
    add_entry3 = Entry(emp_inside_frame,font=("Verdana",11),width=30,bd=2,relief=GROOVE,textvariable=add_address_t1)
    add_entry3.place(x=200,y=179)

    Label(emp_inside_frame,text="Aadhar Num:",font=("Verdana",15),bg="white",fg="#3d3d3d").place(x=20,y=245)
    add_entry4 = Entry(emp_inside_frame,font=("Verdana",11),width=30,bd=2,relief=GROOVE,textvariable=addadhar_t1)
    add_entry4.place(x=200,y=249)

    Label(emp_inside_frame,text="Username:",font=("Verdana",15),bg="white",fg="#3d3d3d").place(x=20,y=315)
    add_entry5 = Entry(emp_inside_frame,font=("Verdana",11),width=30,bd=2,relief=GROOVE,textvariable=addusername_t1)
    add_entry5.place(x=200,y=319)

    Label(emp_inside_frame,text="Password:",font=("Verdana",15),bg="white",fg="#3d3d3d").place(x=20,y=385)
    add_entry6 = Entry(emp_inside_frame,font=("Verdana",11),width=30,bd=2,relief=GROOVE,textvariable=addpassword_t1)
    add_entry6.place(x=200,y=389)

    add_btn = PhotoImage(file="images/buttons/add_btn.png")
    Button(emp_inside_frame,image=add_btn,bg="white",bd=0,borderwidth=0,command=addbtn_func).place(x=80,y=460)

    clr_btn_1 = PhotoImage(file="images/buttons/clear_btn_1.png")
    Button(emp_inside_frame,image=clr_btn_1,bg="white",bd=0,borderwidth=0,command=clrbtn_func).place(x=285,y=460)
...
def employee_window():
    ...
    def invoke_cat_list():
        cat_list["values"] = ["pantry","freezer","basket"]
    ...
    def call_catlist(event):
        ...
        subcat_values = []
        if(cat_list.get() == "basket"):
            product_cursor.execute("select sub_category from products where category='basket' group by sub_category")
        ...
        elif(cat_list.get() == "pantry"):
            product_cursor.execute("select sub_category from products where category='pantry' group by sub_category")
            item = product_cursor.fetchall()
            ...
            product_cursor.execute("select sub_category from products where category='freezer' group by sub_category")
            item = product_cursor.fetchall()
    ...
    def call_subcatlist(event):
        ...
        if(sub_cat_list.get() == "vegetables"):
        ...
        elif(sub_cat_list.get() == "drinks"):
            product_cursor.execute("select product_name from products where sub_category='drinks'")
            item = product_cursor.fetchall()
        ...
        elif(sub_cat_list.get() == "bakery"):
            product_cursor.execute("select product_name from products where sub_category='bakery'")
            item = product_cursor.fetchall()
        ...
        elif(sub_cat_list.get() == "seafood"):
            product_cursor.execute("select product_name from products where sub_category='seafood'")
            item = product_cursor.fetchall()
        ...
        elif(sub_cat_list.get() == "poultry"):
            product_cursor.execute("select product_name from products where sub_category='poultry'")
            item = product_cursor.fetchall()
        ...
        elif(sub_cat_list.get() == "fruit-juices"):
            product_cursor.execute("select product_name from products where sub_category='fruit-juices'")
            item = product_cursor.fetchall()
    ...
    def save_bill():
        ...
        if ans > 0:
            ...
            mycon1 = sql.connect(host='localhost',user='root',password='root',database='grocery_store')
            curs = mycon1.cursor()
            curs.execute("insert into invoices VALUES(%s,%s,%s,%s)",(bill_num.get(),today,cust_name.get(),contact_num.get()))
            mycon1.commit()
            mycon1.close()
        else:
            return
